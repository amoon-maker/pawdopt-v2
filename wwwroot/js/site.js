...
const i18n = {
    en: {
        ...
        'nav-login': 'Log in',
        'fav-toast-title': 'Sign in to save favourites',
        'fav-toast-desc': 'Create a free account to save pets and track your adoption journey.',
        'fav-toast-register': 'Register free',
        ...
        'about-value2-text': 'These transitions can be emotional for everyone involved. Our flows are designed to guide each step gently instead of pushing rushed decisions.',
        ...
        'about-commitment-title': 'Designed for real-life moments with pets',
        'about-commitment-text': 'Whether someone is welcoming a new pet into their life or helping one find a new home, Pawdopt should feel supportive, not transactional.',
        'about-commitment-link': 'See how rehoming works →',
        'about-commitment-link-adopt': 'See how adopting works →',
        'about-cta-title': 'Ready to meet Pawdopt in action?',
        'about-cta-text': 'Explore available pets or list yours — every step is built to feel clear, respectful, and safe.',
        ...
        'footer-contact-desc': "Have a question or feedback? We'd love to hear from you.",
        ...
        'ap-completion-complete':   'Your profile is complete!',
        'ap-completion-incomplete': 'Add your city and phone number, and use the platform, to reach 100%',
        'ap-my-listings-title': 'My pet listings',
        'ap-no-listings':       'No listings yet.',
        'ap-list-a-pet':        'List a pet',
        'ap-listing-continue':       'Continue →',
        'ap-listing-edit-resubmit':  'Edit & resubmit →',
        'ap-listing-delete':         'Delete',
    ...
    fr: {
        ...
        'fav-toast-title': 'Connectez-vous pour sauvegarder',
        'fav-toast-desc': 'Créez un compte gratuit pour sauvegarder des animaux et suivre votre démarche d\'adoption.',
        'fav-toast-register': 'S\'inscrire gratuitement',
        ...
        'about-hero-title': "Chaque animal mérite un chemin réfléchi vers son prochain foyer.",
        'about-hero-subtitle': "Nous avons lancé Pawdopt parce que nous avons vu à quel point l'adoption et le réhébergement d'animaux étaient difficiles — précipité, flou et stressant. Nous avons construit quelque chose de mieux : une plateforme où chaque connexion est guidée, privée et centrée sur le bien-être de l'animal.",
        ...
        'about-value2-text': 'Ces transitions peuvent être émotionnelles pour toutes les personnes impliquées. Nos parcours guident chaque étape avec douceur au lieu de pousser à des décisions hâtives.',
        ...
        'about-commitment-title': "Pensé pour les vrais moments avec les animaux",
        'about-commitment-text': "Qu'il s'agisse d'accueillir un nouvel animal ou d'aider l'un d'eux à trouver un nouveau foyer, Pawdopt doit rester rassurant, pas transactionnel.",
        'about-commitment-link': 'Voir comment fonctionne le réhébergement →',
        'about-commitment-link-adopt': "Voir comment fonctionne l'adoption →",
        ...
        'footer-contact-desc': "Vous avez une question ou un commentaire? Nous aimerions avoir de vos nouvelles.",
        ...
        'pd-msg-send':    'Envoyer le message',
        ...
        'ap-completion-complete':   'Votre profil est complet !',
        'ap-completion-incomplete': 'Ajoutez votre ville et votre numéro de téléphone, et utilisez la plateforme, pour atteindre 100 %',
        'ap-my-listings-title': 'Mes annonces d’animaux',
        'ap-no-listings':       'Aucune annonce pour le moment.',
        'ap-list-a-pet':        'Lister un animal',
        'ap-listing-continue':      'Continuer →',
        'ap-listing-edit-resubmit': 'Modifier et resoumettre →',
        'ap-listing-delete':        'Supprimer',
